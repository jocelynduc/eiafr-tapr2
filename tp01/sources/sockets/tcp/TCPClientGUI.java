...
public class TCPClientGUI extends Frame implements ActionListener {
  ...
  final static String DEFAULT_HOST = "160.98.31.52"; //"localhost";
  ...
  public TCPClientGUI() {
    ...
    // Status line
    statusLabel = new Label("Please enter destination of TCP connection (host/port) ...");
    add(statusLabel);
    statusLabel.setBounds(0, 200, 500, 20);
    statusLabel.setBackground(Color.lightGray);

    setTitle("Sockets Lab - TCPClientGUI (v1.3)");
